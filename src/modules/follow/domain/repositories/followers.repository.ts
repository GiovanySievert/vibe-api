...
export interface FollowersRepository {
  ...
  listFollowers(userId: string, page?: number, limit?: number, viewerId?: string): Promise<ListUserFollowResponseDto[]>
  listFollowings(userId: string, page?: number, limit?: number, viewerId?: string): Promise<ListUserFollowResponseDto[]>
  searchFollowers(userId: string, q: string, page?: number, limit?: number, viewerId?: string): Promise<ListUserFollowResponseDto[]>
  searchFollowings(userId: string, q: string, page?: number, limit?: number, viewerId?: string): Promise<ListUserFollowResponseDto[]>
