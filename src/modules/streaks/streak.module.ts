import { GetFollowedStreaks, GetUserStreak, RecordWeeklyActivity } from './application/use-cases'
...
export const streakController = new StreakController(new GetUserStreak(streakRepo), new GetFollowedStreaks(streakRepo))
